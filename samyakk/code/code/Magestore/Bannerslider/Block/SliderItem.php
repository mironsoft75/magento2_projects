...
class SliderItem extends \Magento\Framework\View\Element\Template
{
     ...
     * @return string
     */
    public function getBannerSmallImageUrl(\Magestore\Bannerslider\Model\Banner $banner)
    {
        if ($banner->getSmallImage()) {
            $smallImage = $this->_bannersliderHelper->getBaseUrlMedia($banner->getSmallImage());
        } else {
            $smallImage = $this->getViewFileUrl("images/logo-banner.png");
        }
        return $smallImage;
    }
