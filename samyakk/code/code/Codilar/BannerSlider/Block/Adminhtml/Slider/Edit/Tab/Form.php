...
namespace Codilar\BannerSlider\Block\Adminhtml\Slider\Edit\Tab;
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField(
            ...
            [
                ...
                'label' => __('Design Identifier'),
                'title' => __('Design Identifier'),
                'required' => false
            ]
        );

        $fieldMaps['show_in_homepage'] = $fieldset->addField(
            'show_in_homepage',
            'select',
            [
                'label' => __('Show in Home Page'),
        ...
        $fieldMaps['slider_device'] = $fieldset->addField(
            'slider_device',
            'select',
            [
                'label' => __('Slider Device'),
                'title' => __('Slider Device'),
                'name' => 'slider_device',
                'options' => \Codilar\BannerSlider\Helper\Data::DEVICES,
                'disabled' => false,
            ]
        );
