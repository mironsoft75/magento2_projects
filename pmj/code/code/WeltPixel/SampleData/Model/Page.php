            ...
            foreach ($rows as $row) {
                ...
                switch ($row['identifier']) {
                    ...
                    case 'weltpixel-brands-widget' :
                        ...
                        $widgetContents = [
                            '{{widget type="WeltPixel\DesignElements\Block\Widget\Brand" style="grid-6" block_id="'. $blockId[0] .'"}}',
                            '{{widget type="WeltPixel\DesignElements\Block\Widget\Brand" style="grid-4" block_id="'. $blockId[0] .'"}}',
                            '{{widget type="WeltPixel\DesignElements\Block\Widget\Brand" style="grid-3" block_id="'. $blockId[1] .'"}}',
                            '{{widget type="WeltPixel\DesignElements\Block\Widget\Brand" style="grid-2" block_id="'. $blockId[2] .'"}}',
                            '{{widget type="WeltPixel\OwlCarouselSlider\Block\Slider\Custom" slider_id="'. $sliderId[0] .'"}}',
                            '{{widget type="WeltPixel\DesignElements\Block\Widget\Brand" style="grid-4" block_id="'. $blockId[0] .'"}}'
                        ];
                        $row['content'] = str_replace($widgetPlaceholders,$widgetContents, $row['content']);
