...
define([
    ...
    $.widget('mage.configurable', {
         ...
         */
        _create: function () {
            // chaning gallery switch strategy
        ...
        _calculatePrice: function (config) {
            ...
            if (newPrices['oldPrice']) {
                oldPrice = newPrices['oldPrice'].amount;
            }
            if (newPrices['finalPrice']) {
                finalPrice = newPrices['finalPrice'].amount;
            }
            if (finalPrice && oldPrice) {
                if (oldPrice > finalPrice) {
                    var savePercent = 100 - this._roundToTwo((finalPrice / oldPrice) * 100);
                    $(".product-discount-percent").removeClass('hide');
                    $(".product-discount-percent").text(this._roundToTwo(savePercent) + "% off");
                }
                else {
                    $(".product-discount-percent").addClass('hide');
