...
namespace Codilar\ShippingPrice\Model\ResourceModel\Carrier\Tablerate\CSV;
...
class RowParser extends \Magento\OfflineShipping\Model\ResourceModel\Carrier\Tablerate\CSV\RowParser
{
    ...
    )
    {
        ...
        $days = $this->getDays($rowData, $columnResolver);
        $city = $this->getCity($rowData, $columnResolver);
        return [
     ...
     * @throws \Magento\OfflineShipping\Model\ResourceModel\Carrier\Tablerate\CSV\ColumnNotFoundException
     */
    private function getDays(array $rowData, ColumnResolver $columnResolver)
    {
        return $columnResolver->getColumnValue('Days', $rowData);
    }
    ...
    {
        return $columnResolver->getColumnValue('City', $rowData);
    }
