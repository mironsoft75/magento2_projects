...
class Image360ModuleCoreClass
{
    ...
    public function getMainTemplate($data, $params = [])
    {
        ...
        $imageUrl = $this->_assetRepo->getUrlWithParams('images/loader-2.gif', $params);
        $html[] = '<div class="image-360-loader"><div class="loader"><img alt="Loading..." src="'. $imageUrl.'"></div></div>';
