...
class Save extends \Codilar\Image360\Controller\Adminhtml\Import
{
    /**
     * Media config
     *
    ...
    public function execute()
    {
        ...
        $importFolderName = isset($data['codilar']['import']['folder']) ? $data['codilar']['import']['folder'] : '';
        ...
        $method = isset($data['codilar']['import']['method']) ? $data['codilar']['import']['method'] : '';
        ...
        $doClear = isset($data['codilar']['import']['clear']) ? ($data['codilar']['import']['clear'] == 'yes') : false;
