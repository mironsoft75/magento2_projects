define([
    ...
    $.widget('mage.amLocator', {
        ...
        _create: function () {
            ...
            $('#filterAttribute').click(function(e){
                self.filterByAttribute()
            });
            $('#limiter_1.limiter-options').change(function(e){
                $('#attribute-form').attr('data-role', 'limiter-1');
                self.filterByAttribute()
            });

            $('#limiter_2.limiter-options').change(function(e){
                $('#attribute-form').attr('data-role', 'limiter-2')
                self.filterByAttribute()
            })
        ...
        filterByAttribute: function(){
            ...
            if($('#attribute-form').attr('data-role') == 'limiter-1') {
                form = $("#attribute-form .test-1").find('select, textarea, input').serialize();
            } else if ($('#attribute-form').attr('data-role') == 'limiter-2') {
                form = $("#attribute-form .test-2").find('select, textarea, input').serialize();
            }
