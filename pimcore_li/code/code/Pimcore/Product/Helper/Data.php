...
namespace Pimcore\Product\Helper;
...
class Data extends AbstractHelper
{
    ...
    public function hasOnlyMakeFilter($request)
    {
        $params = $request->getParams();
        if (isset($params['listinghead_cms_id']) && isset($params['make_name']) && !isset($params['year_id'])) {
            return true;
        }
        return false;
    }
