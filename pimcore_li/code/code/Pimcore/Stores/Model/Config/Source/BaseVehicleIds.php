...
class BaseVehicleIds extends \Magento\Eav\Model\Entity\Attribute\Source\AbstractSource
{
    /**
     * @var OptionFactory
     */
    ...
    {
        $this->_options = $this->getBaseVehicleIds();
     ...
     * @return array
     */
    private function getBaseVehicleIds()
    {
        $ids = $this->ymmApiManagement->getBaseVehicleIds();
        $result = [];
        foreach ($ids as $id) {
