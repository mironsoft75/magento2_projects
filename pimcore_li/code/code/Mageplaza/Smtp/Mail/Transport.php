...
class Transport extends \Magento\Framework\Mail\Transport
{
    ...
    public function sendMessage()
    {
        ...
        $storeId = $objectManager->get('Magento\Framework\Registry')->registry('order_store_id_smtp');
        //$storeId = $this->registry->registry("order_store_id_smtp");
        $objectManager->get('Magento\Framework\Registry')->unregister("order_store_id_smtp");
