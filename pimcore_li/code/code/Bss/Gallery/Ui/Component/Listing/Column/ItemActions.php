...
{
    /** Url path */
    const ITEM_URL_PATH_EDIT = 'gallery/item/edit';
    // const ITEM_URL_PATH_DELETE = 'gallery/item/delete';
        ...
        if (isset($dataSource['data']['items'])) {
            foreach ($dataSource['data']['items'] as & $item) {
                ...
                if (isset($item['item_id'])) {
                    ...
                    // $item[$name]['delete'] = [
                    //     'href' => $this->urlBuilder->getUrl(self::ITEM_URL_PATH_DELETE, ['item_id' => $item['item_id']]),
                    //     'label' => __('Delete'),
                    //     'confirm' => [
