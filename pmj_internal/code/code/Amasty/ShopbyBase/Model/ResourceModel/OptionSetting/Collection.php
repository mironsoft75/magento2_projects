...
class Collection extends \Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection
{
    ...
    public function addTitleToCollection()
    {
        ...
        $this->getSelect()->columns('IF(main_table.title, "empty", option.value) as title');
        $this->getSelect()->columns('IF(main_table.meta_title, "empty", option.value) as meta_title');
