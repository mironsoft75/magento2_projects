	...
	*/
	 ...
	 */
        ...
        var controls = {
            ...
            bindMenuItemShortcuts: function bindMenuItemShortcuts(menuItem, type, cod) {
                // console.log(menuItem,'menuItem',type,'type', cod,'cod');
                var _this2 = this;
            ...
            createMenuItem: function createMenuItem(_ref) {
                ...
                var cod1 = "hello";
                controls.bindMenuItemShortcuts.call(this, menuItem, type, cod1);
                ...
                dedupe(this.config.controls).forEach(function (control) {
                    ...
                    if (control === 'settings' && !is$1.empty(_this10.config.settings)) {
                        ...
                        _this10.config.settings.forEach(function (type) {
                            ...
                            var cod2 = "world";
                            bindMenuItemShortcuts.call(_this10, menuItem, type, cod2); // Show menu on click
        ...
        var defaults$1 = {
            ...
            // Default controls
            controls: ['play-large', // 'restart', 'rewind',
                'play', // 'fast-forward',
            ...
            document.addEventListener('DOMContentLoaded', function () {
                singleton.context(function () {
                    ...
                    var player = new Plyr(selector, {
                        ...
                        previewThumbnails: {
                            enabled: true,
                            src: ['http://127.0.0.1/video/video.vtt', 'http://127.0.0.1/video/video.vtt']
                        }
